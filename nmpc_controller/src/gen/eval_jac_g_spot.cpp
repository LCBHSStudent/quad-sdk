...
/* eval_jac_g_spot:(w[36],p[14])->(jac_g[28x36,129nz]) */
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_spot_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
